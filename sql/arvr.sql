...
INSERT INTO `ar_content` VALUES (1,'s','图片','s','s','1',2),(2,'asdfas','4D空间','dddd','sadfas','0',2),(4,'ewffe','图文','asdfasf','asfaf','0',1),(5,'asdfd','5555','asdf','sssssss','0',NULL),(6,'你好','2222','aaaaaaaa','sssssssss','0',NULL);
...
INSERT INTO `cooperation_case` VALUES (1,'案例1','广东工业大学','这是一个测试用例'),(2,'案例2','个体','这是一个测试用例'),(4,'案例23',NULL,NULL),(5,'aaaa','chip','ddd');
...
INSERT INTO `device` VALUES (2,'ww',NULL,NULL,NULL,3),(3,'4','4','0',NULL,2),(4,'aa','aa',NULL,NULL,4),(5,'asdf','aa',NULL,1,1),(9,'wwww','dd',NULL,1,4),(11,'wwae','asdfas',NULL,2,1),(14,'是v',' 是 ',NULL,NULL,1);
...
INSERT INTO `energy_consumption` VALUES (1,23.00,'23','1',2028,9,'3'),(2,22.00,'w','1',2026,12,'4');
...
INSERT INTO `factory` VALUES (1,'广东工业大学','大学','lazy','123456','黄山'),(2,'GreenTech','专注于环保产品','张三','13800138000','生态路123号'),(3,'TechInnovate','尖端技术解决方案','李四','13900139000','科技路456号'),(4,'BioLife','有机食品和饮料','王五','13700137000','健康街789号'),(5,'SolarCo','可再生能源解决方案','赵六','13600136000','太阳大道101号'),(6,'sadfasdfsaf','sadfsadf','wer','122222222','sadfasdf');
...
INSERT INTO `maintenance_record` VALUES (1,'中午维修','2025-01-14','a师傅',3),(3,'晚上修','2025-01-13','c师傅',2);
...
INSERT INTO `material` VALUES (3,'1','11','1',1,6),(6,'1','1','1',5,5),(7,'1','1','1',1,5),(9,'1','1','1',0,5);
...
INSERT INTO `qr_code` VALUES (1,'aaa','/profile/upload/2025/01/22/Snipaste_2025-01-22_21-08-01_20250122210828A001.png','0'),(2,'bbb','/profile/upload/2025/01/22/Snipaste_2025-01-22_21-08-01_20250122211034A002.png','1'),(3,'1','https://schoolworkweb.oss-cn-beijing.aliyuncs.com/school-images/2025/02/07/67a58431555494c5a76e8775.png','1'),(4,'2','https://schoolworkweb.oss-cn-beijing.aliyuncs.com/school-images/2025/02/07/67a58442555494c5a76e8776.png','1');
...
INSERT INTO `sandbox_zone` VALUES (1,'ww','asd',1,3),(2,'safd','dsdd',2,2),(3,'aa','asd',1,2);
...
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vr_carrier` VALUES (5,'a',1,'0','eee',2),(6,'aa',1,'0','aaa',2),(7,'dd',0,'1','ww',3),(8,'asdf',1,'0','10cm*10cm',6),(10,'eeee',0,'1','300cm*200cm',6);
...
INSERT INTO `vr_content` VALUES (4,'q','文本','aaa',NULL,NULL,NULL,NULL,'2025-01-24 04:50:24','2025-01-24 04:50:24'),(5,'aaa','文本','ss','的','0',5,NULL,'2025-01-24 04:53:47','2025-01-24 04:53:47'),(6,'eee','图片','333','eee','0',NULL,1,'2025-01-24 04:55:37','2025-01-24 04:55:37'),(7,'aa','3D模型','ee','aa','1',NULL,NULL,'2025-01-24 06:45:10','2025-01-24 06:45:10'),(8,'wfd','图片','sadf','asa','0',NULL,NULL,'2025-01-24 06:54:25','2025-01-24 06:54:25'),(9,'啊啊','装置','dasdfas','啊塞缝萨芬','0',NULL,NULL,'2025-01-24 07:32:43','2025-01-24 07:32:43'),(10,'vue','图片','ssss','sdf','0',NULL,NULL,'2025-01-24 09:19:33','2025-01-24 09:19:33'),(11,'啊啊啊','aaa','啊啊啊啊啊啊啊','啊啊啊','0',NULL,NULL,'2025-01-24 09:20:20','2025-01-24 09:20:20'),(12,'wefq','bbb','aaa','dddd','0',NULL,NULL,'2025-01-24 09:23:54','2025-01-24 09:23:54'),(13,'阿是莱肯囧啊零分','ccc','啊啊啊啊啊啊啊啊啊','啊啊啊啊啊啊啊啊啊','0',NULL,NULL,'2025-01-24 09:27:06','2025-01-24 09:27:06'),(14,'www','ddd','asdfasdf','sdaf','0',5,1,'2025-01-24 09:32:11','2025-01-24 09:32:11'),(15,'asdfa','www','wasdfa','asdfsaf','0',6,2,'2025-01-24 09:33:50','2025-01-24 09:33:50'),(16,'asdfa','eee','sadf','dd','0',5,NULL,'2025-01-24 09:34:45','2025-01-24 09:34:45'),(17,'zzzz','动画','sadfas','asdfas','0',NULL,NULL,'2025-01-24 09:44:53','2025-01-24 09:44:53'),(18,'dasdfas','zzz','asfsa','asdf','0',7,NULL,'2025-01-24 09:45:24','2025-01-24 09:45:24'),(19,'asdfas','ooo','sadfa','asdf','0',7,NULL,'2025-01-24 09:45:42','2025-01-24 09:45:42');
...
INSERT INTO `vr_exhibit_zone` VALUES (2,'asdf','ddd',1),(3,'展区1','aaaaaaa',1),(6,'展区2','sadfasf',2),(7,'展区333','wwwww',4);
...
INSERT INTO `vr_material` VALUES (1,'s','文本','aa','dd',1),(2,'tt','文本','tt','ooo',2);
...
INSERT INTO `vr_scene` VALUES (1,'场景1','gdyadbad',NULL,1),(2,'aaa','aaa','sss',1);
...
INSERT INTO `vr_showroom` VALUES (1,'作品展厅','作品展厅是一个大展示厅\n'),(2,'展厅1','sadfasdf'),(3,'展厅2','aaaaaaaa'),(4,'展厅3','龙卡反恐冷\n');
...
INSERT INTO `warehouse_zone` VALUES (4,'2','2',1),(5,'as','ss',4),(6,'11','11',1);
...
INSERT INTO `work` VALUES (1,'作品1','sadf','s','s','s'),(2,'作品2','asdf','aaa','sadf','saf');
...
-- Dump completed on 2025-02-07 12:10:23
