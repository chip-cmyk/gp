...
INSERT INTO `material_transaction` VALUES (1,1,'张三','李五'),(2,0,'吴工','李华'),(3,1,'董明','钟湖');
...
INSERT INTO `material_transaction_detail` VALUES (10,1,1,'2025-02-01'),(10,1,2,'2025-02-10'),(11,2,10000,'2025-02-10'),(11,3,50,'2025-02-03');
...
INSERT INTO `product` VALUES (3,'是',' 啊',NULL,1,5),(4,'智能手环','SW12345','这是一款集健康监测、运动追踪、消息提醒于一体的智能手环，适用于各种场合佩戴。',0,5);
...
) ENGINE=InnoDB AUTO_INCREMENT=160 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=257 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-10 15:22:26
