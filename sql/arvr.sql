...
INSERT INTO `device` VALUES (15,'高效离心泵','高效离心泵是一种用于液体输送的设备，广泛应用于化工、制药和食品加工等行业。它具有高效、节能、运行稳定等特点。','',NULL,2),(16,'自动化装配线','自动化装配线是一种用于大规模生产的设备，能够自动完成产品的组装、检测和包装等工序。它具有高效、精准、稳定等特点。','1',4,5);
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=265 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表字段';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `material_transaction` VALUES (1,1,'张三','李五'),(2,0,'吴工','李华'),(3,1,'董明','钟湖都'),(4,0,'李若希','邓字');
...
INSERT INTO `material_transaction_detail` VALUES (11,2,10000,'2025-02-10'),(11,3,50,'2025-02-03'),(10,1,1,'2025-02-01'),(11,1,2,'2025-02-10'),(10,4,4997,'2025-02-04');
...
INSERT INTO `supply_batch` VALUES (1,1000,'kg','2024-12-10','24个月','上海石化',10);
...
) ENGINE=InnoDB AUTO_INCREMENT=2491 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=267 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-10 15:51:13
