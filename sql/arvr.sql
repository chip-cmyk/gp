...
--
-- Table structure for table `ar_application_configuration`
--

DROP TABLE IF EXISTS `ar_application_configuration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ar_application_configuration` (
  `id` int NOT NULL AUTO_INCREMENT,
  `trigger_method` varchar(255) NOT NULL,
  `display_method` varchar(255) NOT NULL,
  `screen_resolution` varchar(50) NOT NULL,
  `video_resolution` varchar(50) NOT NULL,
  `privacy_settings` varchar(50) NOT NULL,
  `app_id` int NOT NULL,
...
--
-- Dumping data for table `ar_application_configuration`
--

LOCK TABLES `ar_application_configuration` WRITE;
/*!40000 ALTER TABLE `ar_application_configuration` DISABLE KEYS */;
/*!40000 ALTER TABLE `ar_application_configuration` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ar_applications`
--
...
--
-- Dumping data for table `ar_applications`
--

LOCK TABLES `ar_applications` WRITE;
/*!40000 ALTER TABLE `ar_applications` DISABLE KEYS */;
/*!40000 ALTER TABLE `ar_applications` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `device` VALUES (15,'高效离心泵','高效离心泵是一种用于液体输送的设备，广泛应用于化工、制药和食品加工等行业。它具有高效、节能、运行稳定等特点。','0',NULL,2),(16,'自动化装配线','自动化装配线是一种用于大规模生产的设备，能够自动完成产品的组装、检测和包装等工序。它具有高效、精准、稳定等特点。','1',4,5);
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=295 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表字段';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `material` VALUES (10,'钢材','Q235','Q235是一种常用的碳素结构钢，具有良好的塑性和焊接性，广泛应用于建筑、桥梁、车辆等领域。',0,5),(11,'铝合金','6061','6061铝合金是一种常用的热处理型铝合金，具有良好的耐腐蚀性、加工性和焊接性，常用于制造航空、航天、交通等领域的零部件。',0,6);
...
INSERT INTO `material_transaction` VALUES (1,1,'张三','李五'),(2,0,'吴工','李华'),(3,1,'董明','钟湖都'),(4,0,'李若希','邓字'),(5,1,'lay','john');
...
INSERT INTO `material_transaction_detail` VALUES (11,2,10000,'2025-02-10'),(11,3,50,'2025-02-03'),(10,1,1,'2025-02-01'),(11,1,2,'2025-02-10'),(10,4,4997,'2025-02-04'),(11,5,10,'2025-02-11');
...
INSERT INTO `product` VALUES (4,'智能手环','SW12345','这是一款集健康监测、运动追踪、消息提醒于一体的智能手环，适用于各种场合佩戴。',0,5),(5,'无线蓝牙耳机','EB2024','这款无线蓝牙耳机采用最新蓝牙5.3技术，支持高清音质传输，续航时间长达24小时，并具备防水防汗功能。',0,6);
...
INSERT INTO `product_transaction` VALUES (1,0,'李二','王五');
...
INSERT INTO `product_transaction_detail` VALUES (4,1,1,'2024-12-10');
...
INSERT INTO `production_batch` VALUES (1,200,'个','2023-02-13','36个月',5);
...
INSERT INTO `qr_code` VALUES (4,'建模','https://schoolworkweb.oss-cn-beijing.aliyuncs.com/school-images/2025/02/07/67a58442555494c5a76e8776.png','1'),(5,'游戏','https://schoolworkweb.oss-cn-beijing.aliyuncs.com/school-images/2025/02/07/67a5bb28555497ab2a1d23a8.png','0');
...
LOCK TABLES `school_applications` WRITE;
/*!40000 ALTER TABLE `school_applications` DISABLE KEYS */;
/*!40000 ALTER TABLE `school_applications` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `supply_batch` VALUES (1,1000,'kg','2024-12-10','24个月','上海石化',10),(2,1,'1','2025-02-10','1','1',10);
...
INSERT INTO `sys_config` VALUES (1,'主框架页-默认皮肤样式名称','sys.index.skinName','skin-blue','Y','admin','2024-12-24 16:55:23','admin','2025-02-06 14:26:34','蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow'),(2,'用户管理-账号初始密码','sys.user.initPassword','123456','Y','admin','2024-12-24 16:55:23','',NULL,'初始化密码 123456'),(3,'主框架页-侧边栏主题','sys.index.sideTheme','theme-light','Y','admin','2024-12-24 16:55:23','admin','2025-02-06 14:27:01','深色主题theme-dark，浅色主题theme-light'),(4,'账号自助-验证码开关','sys.account.captchaEnabled','true','Y','admin','2024-12-24 16:55:23','',NULL,'是否开启验证码功能（true开启，false关闭）'),(5,'账号自助-是否开启用户注册功能','sys.account.registerUser','true','Y','admin','2024-12-24 16:55:23','',NULL,'是否开启注册用户功能（true开启，false关闭）'),(6,'用户登录-黑名单列表','sys.login.blackIPList','','Y','admin','2024-12-24 16:55:23','',NULL,'设置登录IP黑名单限制，多个匹配项以;分隔，支持匹配（*通配、网段）');
...
) ENGINE=InnoDB AUTO_INCREMENT=132 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='字典类型表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2527 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,103,'admin','小明','00','xiaoming@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2025-02-24 09:49:42','admin','2024-12-24 16:55:22','','2025-02-24 09:49:41','管理员'),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2025-02-12 17:14:26','admin','2024-12-24 16:55:22','','2025-02-12 17:14:25','测试员'),(100,NULL,'lazy','懒酱','00','','','0','','$2a$10$bfxb1pIgr5VGlSi9324Ff.7HkY98ZMqxpnMmqCevfYPwjdZk0IhIO','0','0','127.0.0.1','2025-01-07 20:37:19','admin','2025-01-07 20:37:01','','2025-01-07 20:37:18',NULL),(101,NULL,'yyy','yyy','00','','','0','','$2a$10$IWXTx8hZ42YuNdEFQEKRbObrwlyJNCSdO9Cs5eA5WgqCvIzAMqome','0','0','127.0.0.1','2025-02-12 17:12:44','','2025-02-11 09:05:25','','2025-02-12 17:12:44',NULL);
...
INSERT INTO `sys_user_role` VALUES (1,1),(2,2),(100,100),(101,2);
...
--
-- Table structure for table `vr_applications`
--

DROP TABLE IF EXISTS `vr_applications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `vr_applications`
--

LOCK TABLES `vr_applications` WRITE;
/*!40000 ALTER TABLE `vr_applications` DISABLE KEYS */;
INSERT INTO `vr_applications` VALUES (1,'VR旅游体验','提供沉浸式旅游体验，支持多场景切换。','1.0.0','2023-10-01'),(2,'VR旅游体验','修复了场景加载卡顿的问题，优化了用户体验。','1.1.0','2023-10-15'),(3,'VR教育平台','提供虚拟教室功能，支持多人互动。','1.0.0','2023-11-01');
/*!40000 ALTER TABLE `vr_applications` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `vr_carrier` VALUES (5,'环保主题',1,'0','300cm*200cm',3),(6,'科技主题',1,'1','300cm*200cm',2),(11,'未来主题',0,'0','100cm*250cm',2);
...
-- Dump completed on 2025-02-24 10:48:33
