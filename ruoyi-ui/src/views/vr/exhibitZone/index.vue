<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="exhibitZoneList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="展区名称" prop="exhibitZoneName">
          <el-input v-model="form.exhibitZoneName" placeholder="请输入展区名称" />
        </el-form-item>
...
<script>
import { listExhibitZone, getExhibitZone, delExhibitZone, addExhibitZone, updateExhibitZone } from "@/api/vr/exhibitZone";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除VR展区编号为"' + exhibitZoneIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('vr/exhibitZone/export', {
        ...this.queryParams
