<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="codeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="二维码" align="center" prop="qrCodeImageUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="二维码" prop="qrCodeImageUrl">
          <el-input v-model="form.qrCodeImageUrl" placeholder="请输入二维码" />
        </el-form-item>
      </el-form>
