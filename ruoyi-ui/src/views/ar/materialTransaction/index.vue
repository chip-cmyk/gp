  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="出入库类型" prop="transactionType">
        <el-select v-model="queryParams.transactionType" placeholder="请选择出入库类型" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="materialTransactionList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="出入库类型" prop="transactionType">
          <el-select v-model="form.transactionType" placeholder="请选择出入库类型">
            <el-option
              v-for="dict in dict.type.transaction_type"
              :key="dict.value"
              :label="dict.label"
...
<script>
import { listMaterialTransaction, getMaterialTransaction, delMaterialTransaction, addMaterialTransaction, updateMaterialTransaction } from "@/api/ar/materialTransaction";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除材料出入库单编号为"' + transactionIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ar/materialTransaction/export', {
        ...this.queryParams
