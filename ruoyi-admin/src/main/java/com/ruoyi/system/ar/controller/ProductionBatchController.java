...
import com.ruoyi.system.ar.service.IProductionBatchService;
 ...
 */
@RestController
@RequestMapping("/ar/productBatch")
public class ProductionBatchController extends BaseController
{
     ...
     * 查询生产批次列表
     */
    @PreAuthorize("@ss.hasPermi('ar:productBatch:list')")
    @GetMapping("/list")
     ...
     * 导出生产批次列表
     */
    @PreAuthorize("@ss.hasPermi('ar:productBatch:export')")
     ...
     * 获取生产批次详细信息
     */
    @PreAuthorize("@ss.hasPermi('ar:productBatch:query')")
     ...
     * 新增生产批次
     */
    @PreAuthorize("@ss.hasPermi('ar:productBatch:add')")
     ...
     * 修改生产批次
     */
    @PreAuthorize("@ss.hasPermi('ar:productBatch:edit')")
     ...
     * 删除生产批次
     */
    @PreAuthorize("@ss.hasPermi('ar:productBatch:remove')")
